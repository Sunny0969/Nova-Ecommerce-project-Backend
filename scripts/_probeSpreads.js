...
const files = [
  'C:/Users/PC/Downloads/d.htm',
  'C:/Users/PC/Downloads/dd.htm',
  'C:/Users/PC/Downloads/ddd.htm',
  'C:/Users/PC/Downloads/dddd.htm'
];
...
function skuFromImage(url) {
  const s = String(url || '');
  const code = s.match(/\/(CND\d+|CFG\d+|EDG\d+|DAI\d+|CON\d+)\./i);
