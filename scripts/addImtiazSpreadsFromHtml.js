...
const SOURCE_FILES = [
  { path: 'C:/Users/PC/Downloads/d.htm' },
  { path: 'C:/Users/PC/Downloads/dd.htm' },
  { path: 'C:/Users/PC/Downloads/ddd.htm' },
  { path: 'C:/Users/PC/Downloads/dddd.htm' }
];
const CATEGORY_SLUG = 'spreads';
const CATEGORY_NAME = 'Spreads';
const ID_PREFIX = 'imtiaz_spread';
const PRICE_MARKUP = 10;

const BRAND_RULES = [
  ["Young's", "Young's"],
  ['Choco Bliss', 'Choco Bliss'],
  ['Ponam', 'Ponam'],
  ['National', 'National'],
...
async function ensureCategory() {
  ...
  cat = await Category.create({
    name: CATEGORY_NAME,
    slug: CATEGORY_SLUG,
    description: 'Honey, chocolate spread, jams, marmalades, and chicken spread',
    displayOrder: 22,
    isActive: true,
    image: {
      url: 'https://images.unsplash.com/photo-1587049352846-4a222e784422?w=640&auto=format&fit=crop&q=80',
      public_id: ''
    }
  });
