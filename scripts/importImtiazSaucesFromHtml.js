/**
 * Replace all sauces-dressings-seasonings products with Imtiaz saved HTML.
 * Adds PRICE_MARKUP Rs to each imported price.
 *
 * Run:
 *   node scripts/importImtiazSaucesFromHtml.js
 */
...
const SOURCE_FILES = [
  { path: 'C:/Users/PC/Downloads/s.htm' },
  { path: 'C:/Users/PC/Downloads/sss.htm' },
  { path: 'C:/Users/PC/Downloads/ssss.htm' },
  { path: 'C:/Users/PC/Downloads/sssss.htm' },
  { path: 'C:/Users/PC/Downloads/ssssss.htm' }
];
const CATEGORY_SLUG = 'sauces-dressings-seasonings';
const CATEGORY_NAME = 'Sauces, Dressings & Seasonings';
const ID_PREFIX = 'imtiaz_sauce';
...
function skuFromImage(url) {
  const s = String(url || '');
  const code = s.match(/\/(CND\d+|CFG\d+|EDG\d+|CON\d+)\./i);
...
async function ensureCategory() {
  ...
  cat = await Category.create({
    ...
    isActive: true,
    image: {
      url: 'https://images.unsplash.com/photo-1472476446867-c086569a52cf?w=640&auto=format&fit=crop&q=80',
      public_id: ''
    }
  });
