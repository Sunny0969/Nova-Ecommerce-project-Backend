...
const files = [
  'C:/Users/PC/Downloads/x.htm',
  'C:/Users/PC/Downloads/xx.htm',
  'C:/Users/PC/Downloads/xxx.htm',
  'C:/Users/PC/Downloads/xxxx.htm'
];
...
function skuFromImage(url) {
  const s = String(url || '');
  const code = s.match(/\/(EDG\d+|DAI\d+|CND\d+|CFG\d+|CON\d+)\./i);
