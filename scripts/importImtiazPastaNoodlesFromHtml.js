/**
 * Replace all pasta-noodles products with Imtiaz saved HTML (p11).
 * Adds PRICE_MARKUP Rs to each imported price.
 *
 * Run:
 *   node scripts/importImtiazPastaNoodlesFromHtml.js
 */
...
const SOURCE_FILES = [{ path: 'C:/Users/PC/Downloads/p11.htm', section: 'Pasta' }];
...
async function main() {
  ...
  console.log(`Removed ${removed.deletedCount} existing pasta-noodles products.`);
