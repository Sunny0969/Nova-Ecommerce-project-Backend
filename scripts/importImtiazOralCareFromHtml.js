/**
 * Replace all oral-care products with Imtiaz saved HTML (1, 11, 1111).
 * Creates category if missing. Adds PRICE_MARKUP Rs to each imported price.
 *
 * Run:
 *   node scripts/importImtiazOralCareFromHtml.js
 */
...
const SOURCE_FILES = [
  { path: 'C:/Users/PC/Downloads/1.htm' },
  { path: 'C:/Users/PC/Downloads/11.htm' },
  { path: 'C:/Users/PC/Downloads/1111.htm' }
];
const CATEGORY_SLUG = 'oral-care';
const CATEGORY_NAME = 'Oral Care';
const ID_PREFIX = 'imtiaz_oral';
...
async function ensureCategory() {
  ...
  cat = await Category.create({
    ...
    isActive: true,
    image: {
      url: 'https://images.unsplash.com/photo-1629909613654-28e235c37fe9?w=640&auto=format&fit=crop&q=80',
      public_id: ''
    }
  });
