/**
 * Replace all facial-care products with Imtiaz saved HTML (f, ff, fff, ffff, fffff).
 * Creates category if missing. Adds PRICE_MARKUP Rs to each imported price.
 *
 * Run:
 *   node scripts/importImtiazFacialCareFromHtml.js
 */
...
const SOURCE_FILES = [
  { path: 'C:/Users/PC/Downloads/f.htm' },
  { path: 'C:/Users/PC/Downloads/ff.htm' },
  { path: 'C:/Users/PC/Downloads/fff.htm' },
  { path: 'C:/Users/PC/Downloads/ffff.htm' },
  { path: 'C:/Users/PC/Downloads/fffff.htm' }
];
const CATEGORY_SLUG = 'facial-care';
const CATEGORY_NAME = 'Facial Care';
const ID_PREFIX = 'imtiaz_facial';
const PRICE_MARKUP = 30;
