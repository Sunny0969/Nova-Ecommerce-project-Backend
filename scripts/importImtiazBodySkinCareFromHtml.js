/**
 * Replace all body-skin-care products with Imtiaz saved HTML (2, 22).
 * Creates category if missing. Adds PRICE_MARKUP Rs to each imported price.
 *
 * Run:
 *   node scripts/importImtiazBodySkinCareFromHtml.js
 */
...
const SOURCE_FILES = [
  { path: 'C:/Users/PC/Downloads/2.htm' },
  { path: 'C:/Users/PC/Downloads/22.htm' }
];
const CATEGORY_SLUG = 'body-skin-care';
const CATEGORY_NAME = 'Body & Skin Care';
const ID_PREFIX = 'imtiaz_body';
...
async function ensureCategory() {
  ...
  cat = await Category.create({
    ...
    isActive: true,
    image: {
      url: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=640&auto=format&fit=crop&q=80',
      public_id: ''
    }
  });
