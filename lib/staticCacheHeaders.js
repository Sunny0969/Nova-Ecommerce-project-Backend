...
/** Exactly 6 months in seconds (180 × 24 × 60 × 60). */
const CACHE_STATIC_MAX_AGE = 15_552_000;
...
/**
 * Express static middleware with 6-month cache for assets and no-cache for HTML.
