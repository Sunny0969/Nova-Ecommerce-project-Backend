...
/** Merged into Grocery — never show as separate homepage categories */
/** Merged into Health & Beauty — never show as separate homepage categories */
/** Merged into Home Care — never show as separate homepage categories */
const LEGACY_HOME_CARE_SLUGS = ['laundry', 'cleaning-homecare', 'tissues'];

const LEGACY_HEALTH_BEAUTY_SLUGS = [
  'oral-care',
  'body-skin-care',
  'hair-care',
  'facial-care',
...
const CATEGORY_HERO_IMAGES = {
  ...
  'health-beauty':
    'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=640&auto=format&fit=crop&q=80',
  'home-care':
    'https://images.unsplash.com/photo-1583947581924-860bda6a26df?w=640&auto=format&fit=crop&q=80',
  'ladies-purse':
    'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=640&auto=format&fit=crop&q=80',
  grocery:
    'https://images.unsplash.com/photo-1542838132-92c53300491e?w=640&auto=format&fit=crop&q=80'
};
...
const HOME_CATEGORY_SPECS = [
  ...
  },
  {
    name: 'Grocery',
    slug: 'grocery',
    description: 'Pulses, rice, flour, oils, sauces, spreads, and kitchen staples',
    displayOrder: 2,
    image: {
  ...
  },
  {
    ...
    displayOrder: 3,
    image: imageForSlug('health-beauty', 'photo-1570172619644-dfd03ed5d881')
  },
  {
    name: 'Home Care',
    slug: 'home-care',
    ...
    displayOrder: 4,
    image: imageForSlug('home-care', 'photo-1583947581924-860bda6a26df')
  },
...
async function ensureHomeCategories(Category) {
  ...
  await Category.updateMany({ slug: { $in: LEGACY_GROCERY_SLUGS } }, { $set: { isActive: false } });
  await Category.updateMany({ slug: { $in: LEGACY_HEALTH_BEAUTY_SLUGS } }, { $set: { isActive: false } });
  await Category.updateMany({ slug: { $in: LEGACY_HOME_CARE_SLUGS } }, { $set: { isActive: false } });
...
module.exports = {
  ...
  LEGACY_DEMO_SLUGS,
  LEGACY_GROCERY_SLUGS,
  LEGACY_HEALTH_BEAUTY_SLUGS,
  LEGACY_HOME_CARE_SLUGS,
